...
namespace Hidra.Core
{
    ...
    public class HidraConfig
    {
        ...
        #region New Oscillation Control Properties
        ...
        /// < summary>
        /// A flag to enable or disable the use of `Parallel.ForEach` loops in the simulation step.
        /// </ summary>
        // public bool EnableMultithreading { get; set; } = true;

        /// < summary>
        /// The number of worker threads to suggest for parallel operations.
        /// A value of 0 allows the Task Parallel Library to auto-detect and manage the thread count.
        /// </ summary>
