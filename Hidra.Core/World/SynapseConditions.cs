...
namespace Hidra.Core
{
    ...
    public class TemporalCondition : ICondition
    {
        ...
        /// <summary>
        /// The threshold for edge detection and sustained level checks.
        /// </summary>
        public float Threshold { get; set; }
        
        /// <summary>
        /// The duration in ticks for the Sustained operator.
        /// </summary>
    ...
    {
        /// <summary>
        /// Indicates whether to combine conditions with AND logic. If false, OR logic is used.
        /// </summary>
        public bool IsAndLogic { get; set; }
        public List<ICondition> Conditions { get; set; } = new List<ICondition>();

        /// <summary>
        /// Evaluates the condition based on the provided world state. An empty composite condition always evaluates to true.
        /// </summary>
