...
namespace Hidra.Core
{
    ...
    public class ConditionContext
    {
        ...
        /// <summary>The potential value the source is attempting to transmit before the condition is evaluated.</summary>
    ...
    public class Neuron
    {
        ...
        {
            // Intent: Provide a convenient, reusable way to access a neuron's total potential.
            // These constant indices are a reflection of the private `LVarIndex` enum in `HidraWorld`,
